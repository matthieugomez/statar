#'  Add rows for gaps in variable "along_with"
#'
#' @param .data A tbl_dt, grouped or not
#' @param ... Variables to keep
#' @param along_with integer variable to expand
#' @param type  "within"  means that rows are expanded with respect to min and max of \code{...} within groups (default) while "across" means that dates are expanded with respect to min and max of \code{...} across groups. 
