...
<img src="output_2_0.png" alt="alt text" style="height:50px">


````R
graph(DT, by = id)
````
<img src="output_3_0.png" alt="alt text" style="height:50px">

````R
graph(DT, by = id, type = "boxplot")
````
<img src="box.png" alt="alt text" style="height:50px">


````R
graph(DT, v3, v4, along_with = v2)
````
<img src="v2.png" alt="alt text" style="height:50px">
