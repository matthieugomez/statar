...
The first vignettes presents [the summary functions](vignettes/summary.Rmd), the second presents [the join functions](vignettes/join.Rmd), the third presents [the panel data functions](vignettes/panel-data.Rmd), the fourth presents [string and expression interpolation](vignettes/macros.Rmd).
