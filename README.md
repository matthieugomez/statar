...
The first vignettes presents [the summary functions](/vignettes/summary.md), the second presents [the panel data functions](/vignettes/panel-data.rmd), the third presents [string and expression interpolation](/vignettes/macros.rmd).
