...
It corresponds roughty to the Stata command `reclink`, except that rows in `y` are not thrown away after an exact match with `x`, that the distance can be arbitrarly specified, and that it is faster.
