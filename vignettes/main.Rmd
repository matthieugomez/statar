...
The function `quotem` also works with expressions. Note that, with the pattern `$`, names need to be backquoted so that R accepts these expressions as valid names. 
