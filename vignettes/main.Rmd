...
The functions `quotem` implements string interpolations, similarly to Stata macros and Julia.
...
The function `quotem` can also be applied to expressions. Note that names starting with the pattern `$`  must be enclosed in backquotes to be considered valid names in R.
