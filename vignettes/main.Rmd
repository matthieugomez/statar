...
#> [1] "My record indicates you are 72 inches tall"
```
If the pattern is common, you can use the option `parenthesis.only = TRUE` to replace only expressions following the pattern enclosed in parenthesis. Note the second dot is not replaced in the following string:
```R
