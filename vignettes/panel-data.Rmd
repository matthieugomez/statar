...
### fill_gap
fill_gap transforms a unbalanced panel into a balanced panel. Missing rows for certain dates are added as rows with missing values. It corresponds to the stata command `tsfill`.
```R
df <- data_frame(
    id    = c(1, 1, 1, 2),
