...
Similarly to dplyr function `count`, `tab` prints distinct rows with their count. The function just adds Frequency and Cumulative frequency.
...
The functions syntax are similar to `dplyr` (see the [dplyr vignette](https://github.com/hadley/dplyr/blob/master/vignettes/nse.Rmd) for more details). 
